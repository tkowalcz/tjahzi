...
class LokiAppenderHttpsJvmDefaultTruststoreTest extends HttpsNginxIntegrationTest {
    ...
    void shouldSendDataUsingJvmDefaultTruststore() {
        ...
        Logger logger = context.getLogger(LokiAppenderHttpsJvmDefaultTruststoreTest.class);
                ...
                .returns(response -> response
                        ...
                        .body(
                                ...
                                hasItems(
                                        hasItems(
                                                hasItems(
                                                        containsString("p.t.t.l.LokiAppenderHttpsJvmDefaultTruststoreTest - " + expectedLogLine)
                                                )
                                        )
                                )
                        )
